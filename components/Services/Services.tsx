...
const services = [
  ...
  },
  {
    ...
    description:
      "Индивидуальная комплексная помощь после сбора всех показателей: ЭКГ, артериальное давление, пульс, глюкоза крови. Терапия зависит от тяжести состояния пациента.",
  ...
  },
  {
    ...
    description:
      "Стоимость зависит от срока действия препарата и производителя.",
    price: "от 8 000 — 12 000 ₽ / год",
  },
  {
    id: 4,
    title: "Снятие абстинентного синдрома",
    subtitle: "похмелье, ломка",
    description:
